const activity = [
  {
    avatar: 'AK',
    text: 'Anika linked PR #284 to the API redesign',
    time: '2m',
  },
  {
    avatar: 'RS',
    text: 'Rish awarded 25 points for a merged feature',
    time: '8m',
  },
  ...
  return (
    <div className="surface overflow-hidden text-left">
      <div className="flex items-center border-b border-[var(--line)] px-4 py-3">
        ...
        <span className="mx-auto font-mono text-[10px] text-[#999] dark:text-neutral-400">
        ...
        <div className="min-w-0 bg-white dark:bg-neutral-950 p-4 sm:p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="mt-1 text-lg font-extrabold text-ink dark:text-neutral-100">
                Program overview
              </h3>
            </div>
          ...
          <div className="mt-5 grid grid-cols-2 gap-2 lg:grid-cols-4">
            {[
              ...
              >
                <p className="text-[9px] text-[#888] dark:text-neutral-400">
                  {label}
                </p>
                <p className="mt-1 text-lg font-black text-ink dark:text-neutral-100">
                  {value}
                </p>
              </div>
            ))}
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-[1.2fr_.8fr]">
            <div className="rounded-xl border border-[var(--line)] p-4">
              <p className="text-xs font-bold text-ink dark:text-neutral-200">
                ...
                {activity.map((item) => (
                  <div key={item.text} className="flex gap-2">
                    ...
                    <p className="text-[9px] leading-4 text-[#555] dark:text-neutral-300">
                      {item.text}{' '}
                      <span className="text-[#aaa] dark:text-neutral-500">
                        · {item.time}
                      </span>
                    </p>
                  </div>
