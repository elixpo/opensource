    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh] sm:pt-[15vh]">
          <div className="fixed inset-0 bg-text-bright/60 backdrop-blur-sm transition-opacity" onClick={() => setOpen(false)} />
          <div className="relative z-50 w-full max-w-xl rounded-xl border border-muted/20 bg-card shadow-2xl overflow-hidden" role="dialog" aria-modal="true">
            ...
            <div className="max-h-[300px] overflow-y-auto p-2">
              ...
              <div className="flex flex-col gap-1 mt-1">
                <button className="w-full rounded-md px-3 py-2 text-left text-sm text-text-bright hover:bg-muted/10 hover:text-primary transition-colors flex items-center gap-2">
