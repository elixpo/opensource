      ...
      <div className="shell flex h-16 items-center justify-between gap-4">
        ...
        <nav aria-label="Global" className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <a
              href={`${publicEnv.accountsUrl}/profile`}
              className="flex h-8 w-8 items-center justify-center rounded-full bg-muted/20 text-sm font-bold text-text-bright hover:bg-primary hover:text-bg transition-colors"
            >
              U
            </a>
          </div>
