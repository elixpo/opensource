		...
		>
				...
				<div className="grid gap-1 flex-1">
					...
					{toast.description && (
						<div
							className={cn(
								"text-sm opacity-90",
								isError ? "text-bg" : "text-text-bright",
							)}
						>
							{toast.description}
						</div>
			...
			<button
				...
				className={cn(
					...
					isError
						? "text-bg hover:text-bg/80 focus:ring-bg focus-visible:outline-none focus-visible:ring-2"
						: "text-text-bright/50 hover:text-text-bright focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
				)}
			>
				<Icon size={16}>
