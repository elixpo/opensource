    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            'bg-text-bright text-bg hover:-translate-y-0.5 hover:bg-[#1a1a24] active:translate-y-0':
              variant === 'primary',
            'border border-muted/20 bg-card hover:-translate-y-0.5 hover:border-muted/40 hover:bg-[#ffe3b0] active:translate-y-0 text-text-bright':
              variant === 'secondary',
            'hover:bg-muted/10 text-text-bright active:bg-muted/20':
              variant === 'ghost',
