	...
	return (
		<main>
			...
			<section className="relative overflow-hidden pb-20 pt-20 md:pb-28 md:pt-28">
				...
				<div className="shell text-center">
					...
					<h1 className="mx-auto mt-7 max-w-5xl text-[clamp(2.8rem,7vw,6.3rem)] font-black leading-[.94] tracking-[-.055em]">
						Run open source.
						<br />
						<span className="font-bold italic text-[#888]">
							Skip the busywork.
						</span>
					</h1>
					<p className="mx-auto mt-7 max-w-2xl text-[1.05rem] leading-7 text-[#555] md:text-lg">
					...
					<p className="mt-4 font-mono text-[10px] uppercase tracking-wider text-[#999]">
			...
			<div className="overflow-hidden border-y border-[var(--line)] bg-cream py-4">
				<div className="ticker flex w-max items-center gap-12 whitespace-nowrap font-mono text-[11px] font-bold uppercase tracking-[.12em] text-[#777]">
					{[...Array(2)]
						.flatMap(() => [
							"Programs",
							"Contributors",
			...
			<section id="platform" className="shell py-24 md:py-32">
				...
				<div className="mt-3 grid gap-5 md:grid-cols-2">
					...
					<p className="max-w-xl text-base leading-7 text-[#666]">
