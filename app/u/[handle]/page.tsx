							...
							<>
								<div className="surface p-8 flex flex-col md:flex-row items-center gap-6">
									...
									<div className="text-center md:text-left flex-1">
										...
										<p className="text-sm text-[#777] dark:text-neutral-500">
											@{user.handle}
										</p>
									...
									<div className="grid grid-cols-3 gap-6 border-t md:border-t-0 md:border-l border-[var(--line)] dark:border-neutral-800 pt-6 md:pt-0 md:pl-8 w-full md:w-auto text-center">
										<div>
											...
											<p className="text-[10px] font-mono font-bold text-[#777] uppercase">
												Points
											</p>
										</div>
										<div>
											<p className="text-3xl font-black text-ink dark:text-neutral-200">
												{user.prs}
											</p>
											<p className="text-[10px] font-mono font-bold text-[#777] uppercase">
												PRs Merged
								...
								<div className="mt-8">
									<h2 className="text-xl font-bold text-ink dark:text-neutral-200 mb-4">
