									...
									>
										<div className="flex-1">
											<div className="flex flex-wrap items-center gap-3">
												...
												<span className="text-[10px] text-[#777] dark:text-neutral-500">
													{n.time}
												</span>
											</div>
											<h3 className="mt-3 text-lg font-bold text-ink dark:text-neutral-200">
												{n.title}
											</h3>
											<p className="mt-1.5 text-sm leading-relaxed text-[#555] dark:text-neutral-400">
												{n.desc}
											</p>
										</div>
