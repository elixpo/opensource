          ...
          <div className="shell">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-3">
              <div className="surface p-6">
                ...
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">$0.00</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">No active payout scheduled</p>
              </div>
              <div className="surface p-6">
                <p className="text-xs text-[#777] dark:text-neutral-500 font-mono font-bold uppercase">Pending Approval</p>
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">$0.00</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">No pending validations</p>
              </div>
              <div className="surface p-6">
            ...
            <div className="mt-8 surface p-6 text-center max-w-xl mx-auto">
              ...
              <h3 className="mt-4 text-lg font-bold text-ink dark:text-neutral-200">No Linked Payout Method</h3>
              <p className="mt-2 text-sm text-[#666] dark:text-neutral-400">
                You must be logged in to connect your Wise or Stripe account and view financial transactions.
              </p>
            </div>
          </div>
        </section>
