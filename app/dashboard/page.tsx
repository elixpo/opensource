          ...
          <div className="shell">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="surface p-5">
                ...
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">—</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">Level details locked</p>
              </div>
              <div className="surface p-5">
                <p className="text-xs text-[#777] dark:text-neutral-500 font-mono font-bold uppercase">Total Points</p>
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">0</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">No points accrued yet</p>
              </div>
              <div className="surface p-5">
                <p className="text-xs text-[#777] dark:text-neutral-500 font-mono font-bold uppercase">PRs Merged</p>
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">0</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">No merged contributions</p>
              </div>
              <div className="surface p-5">
                <p className="text-xs text-[#777] dark:text-neutral-500 font-mono font-bold uppercase">Streak</p>
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-400">0 days</p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-600">No active contribution streak</p>
              </div>
            </div>
            ...
            <div className="mt-10 surface p-12 text-center max-w-xl mx-auto">
              ...
              <h2 className="mt-4 text-lg font-bold text-ink dark:text-neutral-200">Session Required</h2>
              <p className="mt-2 text-sm text-[#777] dark:text-neutral-500">
                You must sign in with GitHub to view your active claimed issues, submit pull requests, and track sprint scores.
              </p>
            </div>
          </div>
        </section>
