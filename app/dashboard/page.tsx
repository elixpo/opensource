          ...
          <div className="shell">
            ...
            <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              <div className="surface p-5">
                <p className="text-xs text-[#777] dark:text-neutral-400 font-mono font-bold uppercase">
                  Level
                </p>
                <p className="mt-2 text-3xl font-black text-ink dark:text-neutral-100">
                  —
                </p>
                <p className="mt-1 text-[11px] text-[#999] dark:text-neutral-400">
            ...
            <div className="mt-10 surface p-12 text-center max-w-xl mx-auto">
              ...
              <h2 className="mt-4 text-lg font-bold text-ink dark:text-neutral-100">
                Session Required
              </h2>
              <p className="mt-2 text-sm text-[#777] dark:text-neutral-400">
