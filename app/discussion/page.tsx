      ...
      <div>
        ...
        <section className="shell py-16 md:py-24">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center justify-between mb-8">
            ...
            <Button variant="primary" className="whitespace-nowrap w-full md:w-auto">
              Open Discussion
            </Button>
          </div>
              ...
              >
                  ...
                  <div className="flex flex-wrap items-center gap-3 text-xs text-[#777] dark:text-neutral-500">
                    ...
                    <div className="flex items-center gap-1">
                      {discussion.tags.map(tag => (
                        <span key={tag} className="text-[10px] text-[#555] dark:text-neutral-400 hover:text-ink dark:hover:text-white transition">
                          #{tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className="flex items-center gap-4 text-xs font-mono text-[#777] dark:text-neutral-400 shrink-0">
                  ...
                  <div className="hidden md:flex flex-col items-end">
                    <span className="text-ink dark:text-neutral-300">{discussion.updatedAt}</span>
