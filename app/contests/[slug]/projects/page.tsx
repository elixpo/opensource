					...
					<div className="shell">
						...
						<div className="mt-12 grid gap-6 md:grid-cols-2">
							{projects.map((project) => (
								<div
									key={project.name}
									className="surface p-6 flex flex-col justify-between hover:border-[#bbb] transition group"
								>
									<div>
										...
										<h3 className="mt-4 text-lg font-bold group-hover:text-accent transition">
