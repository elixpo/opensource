          ...
          <div className="shell max-w-md">
            <div className="surface p-8 text-center flex flex-col gap-6">
              <div>
                ...
                <h1 className="mt-6 text-2xl font-black text-ink dark:text-neutral-100">Join Elixpo</h1>
                <p className="mt-1.5 text-xs text-[#777] dark:text-neutral-500">Create an account to participate in sprints and earn rewards.</p>
              </div>
